...
class _HomeTabState extends State<HomeTab> {
        ...
        child: Column(
          ...
          children: [
            ...
            if (widget.isLoadingFare) ...[
              ...
              Text(
                '৳${widget.fareQuote!.fare.toStringAsFixed(0)}',
                style: Theme.of(
                  context,
              ...
              Text(
                'Payable: ৳${_payableFare(widget.fareQuote!.fare).toStringAsFixed(0)}',
                style: Theme.of(context).textTheme.titleMedium?.copyWith(
                  color: Theme.of(context).colorScheme.primary,
                ),
              ),
              ...
              if (autoFare != null) ...[
                ...
                const SizedBox(height: 6),
                Text(
                  'Payable: ৳${_payableFare(autoFare).toStringAsFixed(0)}',
                  style: Theme.of(context).textTheme.titleMedium?.copyWith(
                    color: Theme.of(context).colorScheme.primary,
                  ),
                ),
                ...
                if (estimatedFare != null) ...[
                  Text(
                    'Estimated: ৳${estimatedFare.toStringAsFixed(0)}  (rate ৳${AppConfig.fallbackRatePerKm}/km)',
                    style: Theme.of(context).textTheme.bodyMedium,
                  ),
                  const SizedBox(height: 4),
                  Text(
                    'Payable: ৳${_payableFare(estimatedFare).toStringAsFixed(0)}',
                    style: Theme.of(context).textTheme.titleMedium?.copyWith(
                      color: Theme.of(context).colorScheme.primary,
                    ),
                  ),
  ...
  Widget _popularButton(String fromId, String toId) {
    ...
    final color = colors[(fromId.hashCode + toId.hashCode) % colors.length];
